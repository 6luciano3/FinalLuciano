 ...
 */
package com.Porfolio.Luciano.Security.Controller;

import com.Porfolio.Luciano.Security.Dto.JwtDto;
import com.Porfolio.Luciano.Security.Dto.LoginUsuario;
import com.Porfolio.Luciano.Security.Dto.NuevoUsuario;
...
public class AuthController {
    ...
    @PostMapping("/nuevo")
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bidingResult){
